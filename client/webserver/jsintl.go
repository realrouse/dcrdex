...
var ptBR = map[string]*intl.Translation{
	...
	canceledPartiallyFilledID: {T: "cancelado/parcialmente preenchido"},
	revokedPartiallyFilledID:  {T: "revogado/parcialmente preenchido"},
...
var zhCN = map[string]*intl.Translation{
	...
	canceledID:                       {T: "取消"},
	revokedID:                        {T: "撤销"},
	canceledPartiallyFilledID:        {T: "取消/部分成交"},
	revokedPartiallyFilledID:         {T: "撤销/部分成交"},
...
var deDE = map[string]*intl.Translation{
	...
	canceledPartiallyFilledID:        {T: "abgebrochen/teilweise ausgeführt"},
	revokedPartiallyFilledID:         {T: "widerrufen/teilweise ausgeführt"},
